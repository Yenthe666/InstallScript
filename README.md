...
```IS_ENTERPRISE``` will install the Enterprise version on top of ```10.0``` if you set it to ```True```, set it to ```False``` if you want the community version of Odoo 10.<br/>
