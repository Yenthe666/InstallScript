#!/bin/bash
################################################################################
# Script for installing Odoo V10 on Debian 10 (could be used for other version too)
...
sudo apt-get install wget git python python-pip build-essential python-dev python-wheel libxslt1-dev libzip-dev libldap2-dev libsasl2-dev python-setuptools node-less libpng16-16 gdebi-core libpq-dev -y
